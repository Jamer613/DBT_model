...
epidemiology_join as (
    ...
    select        
        ...
        iff(epidemiology.new_confirmed = 'NaN', 0.0, epidemiology.new_confirmed) as new_confirmed,
        iff(epidemiology.new_deceased = 'NaN', 0.0, epidemiology.new_deceased) as new_deceased,
        iff(epidemiology.new_recovered = 'NaN', 0.0, epidemiology.new_recovered) as new_recovered,
        iff(epidemiology.new_tested = 'NaN', 0.0, epidemiology.new_tested) as new_tested,
        iff(epidemiology.cumulative_confirmed = 'NaN', 0.0, epidemiology.cumulative_confirmed) as cumulative_confirmed,
        iff(epidemiology.cumulative_deceased = 'NaN', 0.0, epidemiology.cumulative_deceased) as cumulative_deceased,
        iff(epidemiology.cumulative_recovered = 'NaN', 0.0, epidemiology.cumulative_recovered) as cumulative_recovered,
        iff(epidemiology.cumulative_tested = 'NaN', 0.0, epidemiology.cumulative_tested) as cumulative_tested,
        economy.gdp_usd,
